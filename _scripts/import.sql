...
\COPY vtracker(province, district, municipality, municipality_code, barangay, precinct, voters, leader, contact, target) FROM '../_data/to_import/converted/district_1.csv' DELIMITER ',' CSV HEADER ENCODING 'UTF8';
\COPY vtracker(province, district, municipality, municipality_code, barangay, precinct, voters, leader, contact, target) FROM '../_data/to_import/converted/district_2.csv' DELIMITER ',' CSV HEADER ENCODING 'UTF8';
\COPY vtracker(province, district, municipality, municipality_code, barangay, precinct, voters, leader, contact, target) FROM '../_data/to_import/converted/district_3.csv' DELIMITER ',' CSV HEADER ENCODING 'UTF8';
