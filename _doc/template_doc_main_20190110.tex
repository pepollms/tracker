\usepackage[top=1.0in, bottom=1.25in, left=1.0in, right=1.0in, footskip=0.4in, bindingoffset=0.7in]{geometry}
...
$if(title)$
    ...
    \begin{flushleft}
        ...
        $for(author)$
            $if(author.name)$
                {\fontsize{14pt}{14pt}\usefont{T1}{ptm}{b}{it}$author.name$\\}
                $if(author.email)$
        ...
        $if(distribution)$
            % Add a vertical fill so the distribution text is pushed down the
            % bottom of the page.
            %
